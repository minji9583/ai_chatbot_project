...
def enc_processing(value, dictionary):
    ...
    for seq in value:
        ...
        # print(DEFINES.max_sequence_length)
        # print(seq_index)
    ...
    for i in value:
        ...
        for key in i['indexs']:
            ...
            if dictionary.get(key) is not None:
                ...
                answer += ' '
            # print('dictionary', dictionary.get(key))
        # sentence_string = [dictionary[index] for index in i['indexs']]
